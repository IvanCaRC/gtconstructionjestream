                ...
                <div class="table-responsive">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <input type="text" class="form-control mr-2" id="searchInput" wire:model='searchTerm'
                            wire:keydown='search' placeholder="Buscar Cliente...">
                    </div>
                </div>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <div class="categoria-header">
                                ...
                                <div><strong>Proyectos totales</strong></div>
                                <div><strong>Proyectos activos</strong></div>
                                <div><strong>Direcciones</strong></div>
