<div>
    ...
    <x-dialog-modal wire:model="openModalActualizarProyecto">
        <x-slot name='title'>
            Actualizar proyecto
        </x-slot>
        <x-slot name='content'>
        ...
        <x-slot name='footer'>
            <button type="button" class="btn btn-secondary mr-2 disabled:opacity-50" wire:click="cancelarUpdate"
                wire:loading.attr="disabled">Cancelar</button>
            <button type="button" class="btn btn-primary disabled:opacity-50" wire:loading.attr="disabled"
                wire:click="actualizarProyecto">
                Actualizar Proyecto
            </button>
        </x-slot>
    </x-dialog-modal>
