        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <!-- Input de búsqueda -->
                        <button class="btn btn-custom" wire:click="$toggle('tipoDeVista')"
                            ...
                            @foreach ($item->itemEspecificos as $itemEspecifico)
                                <div class="col-md-4 mb-4">
                                    <div class="card shadow-sm">
                                        <!-- Imagen del Item -->
                                        hola
                                        <img src="{{ $itemEspecifico->image ? explode(',', $itemEspecifico->image)[0] : 'ruta_por_defecto.jpg' }}" 
     class="card-img-top" 
     alt="{{ $item->nombre }}">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!-- Stock -->
                                            <p class="card-text">
                                                <strong>Stock:</strong> {{ $itemEspecifico->unidad ?? 'N/A' }}
                                            </p>
                    
                                            <!-- Fecha de Actualización -->
                                            <p class="card-text text-muted">
                                                Última actualización: {{ $item->updated_at->format('d/m/Y') }}
                                            </p>
                    
                                            <!-- Botón de Ver -->
                                            <button class="btn btn-info btn-sm" wire:click="viewItem({{ $itemEspecifico->id }})">
