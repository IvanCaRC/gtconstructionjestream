            ...
            <div class="col-md-4">
                ...
                <div class="card border-left-primary shadow mb-3" style="min-height: 100px;">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Utilidades (Mensuales)</div>
                ...
                <div class="card border-left-success shadow mb-3" style="min-height: 100px;">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Utilidades (Anuales)</div>
