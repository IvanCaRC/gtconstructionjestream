<style>
    .table thead th {
        border-top: 0; /* Elimina el borde superior de los encabezados de la tabla */
    }
</style>
                    ...
                    <table class="table table-sm" style="width: 100%;"> <!-- Tabla compacta -->
                        <thead>
                            <tr>
                                ...
                                <th class="d-none d-md-table-cell" wire:click="order('first_last_name')" style="cursor: pointer; width: 40%;">Descripción</th> <!-- Ajustar ancho de la columna -->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle d-none d-md-table-cell">Se encarga de administrar el usuario</td>
                                <td>
                                    <button class="btn btn-info btn-sm" style="margin-left: 10px;"> <!-- Añadido margen para más espacio -->
