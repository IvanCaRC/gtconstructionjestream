<div class="form-group">
    <div class="d-flex justify-content-center align-items-center mt-2">
        ...
        <!-- Input de cantidad -->
        <input type="text" min="1" class="form-control text-center" style="width: 90px;" wire:model="cantidad"
    ...
    <div>
        <button
            class="btn btn-success btn-custom" wire:click="agregarItemStockLista('{{ $itemEspecifico->id }}|{{ $item->nombre }}')"
